...
<link href="/thinkp/Public/Admin/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<img src="/thinkp/Public/Admin/assets/admin/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	...
	<form class="login-form" action="" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="adminname"/>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">密码</label>
			<input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" name="adminpad"/>
		</div>
